...
*It assumes that you keep your data tidy*: each variable (type/taxon) must be saved in its own column and each observation (sample/case) must be saved in its own row.
